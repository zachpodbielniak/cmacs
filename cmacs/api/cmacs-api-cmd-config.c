...
gint
cmd_set(CmacsApiTransport *transport, gint argc, gchar **argv)
{
    gchar *esc_val, *elisp;
    gint rc;
    const gchar *var, *val;
...
gint
cmd_get_var(CmacsApiTransport *transport, gint argc, gchar **argv)
{
    gchar *elisp;
    gint rc;
...
gint
cmd_theme(CmacsApiTransport *transport, gint argc, gchar **argv)
{
    gchar *elisp;
    gint rc;
...
gint
cmd_font(CmacsApiTransport *transport, gint argc, gchar **argv)
{
    gchar *esc_fam, *elisp;
    gint rc;
    ...
    esc_fam = cmacs_api_lisp_escape(argv[2]);
...
gint
cmd_mode(CmacsApiTransport *transport, gint argc, gchar **argv)
{
    gchar *elisp;
    gint rc;
