...
gint
cmd_grep(CmacsApiTransport *transport, gint argc, gchar **argv)
{
    ...
    esc_pat = cmacs_api_lisp_escape(argv[2]);

    if (argc >= 4)
    {
        esc_dir = cmacs_api_lisp_escape(argv[3]);
...
gint
cmd_find(CmacsApiTransport *transport, gint argc, gchar **argv)
{
    ...
    esc_name = cmacs_api_lisp_escape(argv[2]);
...
gint
cmd_project_root(CmacsApiTransport *transport, gint argc, gchar **argv)
{
    (void)argc;
    (void)argv;
...
gint
cmd_compile(CmacsApiTransport *transport, gint argc, gchar **argv)
{
    GString *cmd;
    gchar *escaped, *elisp;
    gint i, rc;
    ...
    escaped = cmacs_api_lisp_escape(cmd->str);
...
gint
cmd_next_error(CmacsApiTransport *transport, gint argc, gchar **argv)
{
    (void)argc;
    (void)argv;
    return cmacs_api_eval_quiet(transport, "(next-error)");
}

gint
cmd_prev_error(CmacsApiTransport *transport, gint argc, gchar **argv)
{
    (void)argc;
    (void)argv;
    return cmacs_api_eval_quiet(transport, "(previous-error)");
}

gint
cmd_diag(CmacsApiTransport *transport, gint argc, gchar **argv)
{
    const gchar *buf;
    gint i;
    gchar *esc, *elisp;
