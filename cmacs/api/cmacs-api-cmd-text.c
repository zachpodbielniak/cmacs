...
gint
cmd_insert(CmacsApiTransport *transport, gint argc, gchar **argv)
{
    const gchar *buf;
    gint pos, i;
    GString *text;
...
gint
cmd_delete(CmacsApiTransport *transport, gint argc, gchar **argv)
{
    const gchar *buf;
    gint dummy_pos, i;
    gint start, end;
...
gint
cmd_line(CmacsApiTransport *transport, gint argc, gchar **argv)
{
    const gchar *buf;
    gint dummy_pos, i;
    gint line_num;
...
gint
cmd_append(CmacsApiTransport *transport, gint argc, gchar **argv)
{
    const gchar *buf;
    gint dummy_pos, i;
    GString *text;
