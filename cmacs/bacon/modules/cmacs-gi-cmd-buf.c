...
buf_save_as(GDBusProxy *proxy, gint argc, gchar **argv)
{
    ...
    esc_buf  = cmacs_gi_lisp_escape(argv[3]);
    esc_path = cmacs_gi_lisp_escape(argv[4]);
    elisp = g_strdup_printf(
...
buf_rename(GDBusProxy *proxy, gint argc, gchar **argv)
{
    ...
    esc_old = cmacs_gi_lisp_escape(argv[3]);
    esc_new = cmacs_gi_lisp_escape(argv[4]);
    elisp = g_strdup_printf(
...
static const CmacsGiSubcmd buf_subcmds[] = {
