...
(defconst cmacs-calculator-sheet--calc-functions
  '("sqrt" "abs" "sign" "exp" "ln" "log" "log10" "sin" "cos" "tan"
    "arcsin" "arccos" "arctan" "arctan2" "sinh" "cosh" "tanh"
    "floor" "ceil" "round" "trunc" "min" "max" "fact" "gcd" "lcm"
    "deriv" "integ" "solve" "subst" "evalv" "usimplify" "simplify"
    "expand" "factor" "pv" "fv" "pmt" "nper" "rate" "npv" "irr"
    "sln" "syd" "ddb" "ltpn" "utpn" "re" "im" "conj" "arg")
  "Common GNU Calc functions a sheet should know about.
The registry covers what cmacs adds; this covers what Calc already had,
so completion and font-lock do not pretend `sqrt' is unknown.")
