...
(defvar cmacs-dbexplorer-schema-mode-map
  (let ((map (make-sparse-keymap)))
    ...
    (define-key map (kbd "g j") #'cmacs-dbexplorer-schema-next-sibling)
    (define-key map (kbd "g k") #'cmacs-dbexplorer-schema-previous-sibling)
    (define-key map (kbd "g r") #'cmacs-dbexplorer-schema-refresh)
